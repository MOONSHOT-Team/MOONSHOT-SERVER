...
public class ImageController {
    ...
    public ApiResponse<PresignedUrlVO> getPresignedUrl() {
        return ApiResponse.success(SuccessType.GET_PRESIGNED_URL_SUCCESS, s3Service.getUploadPreSignedUrl("test", "SMC"));
    }
    ...
    public ApiResponse<?> notifyImageSaveSuccess(@RequestBody NotifyImageSaveSuccessRequestDto request) {
        ...
        return ApiResponse.success(SuccessType.POST_NOTIFY_IMAGE_SAVE_SUCCESS);
    }
